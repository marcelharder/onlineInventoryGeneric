    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTypes", x => x.ValveTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PTValveTypeId = table.Column<int>(nullable: true),
                    ValveTypeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Valve_sizes_ProductTypes_PTValveTypeId",
                        column: x => x.PTValveTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Valve_sizes_PTValveTypeId",
                table: "Valve_sizes",
                column: "PTValveTypeId");
        }
